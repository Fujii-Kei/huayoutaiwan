...
Answer.create!(body: "いくらですか", question_id: 21, is_correct: true)
Answer.create!(body: "これをください", question_id: 21, is_correct: false)
Answer.create!(body: "持ち帰ります", question_id: 21, is_correct: false)
Answer.create!(body: "おいしいです", question_id: 21, is_correct: false)
Question.create!(title: "可以試穿嗎？", body: "正しい日本語訳を選びましょう", category_id: 4)
Answer.create!(body: "いくらですか", question_id: 22, is_correct: false)
Answer.create!(body: "これをください", question_id: 22, is_correct: false)
Answer.create!(body: "試着してもいいですか", question_id: 22, is_correct: true)
Answer.create!(body: "おいしいです", question_id: 22, is_correct: false)
Question.create!(title: "有其他顏色嗎？", body: "正しい日本語訳を選びましょう", category_id: 4)
Answer.create!(body: "いくらですか", question_id: 23, is_correct: false)
Answer.create!(body: "これをください", question_id: 23, is_correct: false)
Answer.create!(body: "試着してもいいですか", question_id: 23, is_correct: false)
Answer.create!(body: "他の色はありますか", question_id: 23, is_correct: true)
Question.create!(title: "可以用信用卡嗎", body: "正しい日本語訳を選びましょう", category_id: 4)
Answer.create!(body: "いくらですか", question_id: 24, is_correct: false)
Answer.create!(body: "クレジットカードは使えますか", question_id: 24, is_correct: false)
Answer.create!(body: "試着してもいいですか", question_id: 24, is_correct: false)
Answer.create!(body: "値引きはありますか", question_id: 24, is_correct: true)
...
Answer.create!(body: "試着してもいいですか", question_id: 25, is_correct: false)
Answer.create!(body: "返品できますか", question_id: 25, is_correct: true)
Question.create!(title: "還有大一點的尺寸嗎", body: "正しい日本語訳を選びましょう", category_id: 4)
Answer.create!(body: "もう少し大きいサイズはありますか", question_id: 26, is_correct: true)
Answer.create!(body: "もう少し小さいサイズはありますか", question_id: 26, is_correct: false)
...
Answer.create!(body: "もう少し大きいサイズはありますか", question_id: 27, is_correct: false)
Answer.create!(body: "もう少し小さいサイズはありますか", question_id: 27, is_correct: true)
Answer.create!(body: "試着してもいいですか", question_id: 27, is_correct: false)
Answer.create!(body: "これをください", question_id: 27, is_correct: false)
Category.create!(name: "ホテル", body: "ホテルで使える表現を学びましょう")
Question.create!(title: "我預訂的是〇〇", body: "正しい日本語訳を選びましょう", category_id: 5)
Answer.create!(body: "チェックアウトは何時ですか", question_id: 28, is_correct: false)
Answer.create!(body: "タクシーを呼んでもらえますか", question_id: 28, is_correct: false)
Answer.create!(body: "予約した〇〇です", question_id: 28, is_correct: true)
Answer.create!(body: "近くにおすすめの飲食店はありますか", question_id: 28, is_correct: false)
Question.create!(title: "我們可以先放行李嗎", body: "正しい日本語訳を選びましょう", category_id: 5)
Answer.create!(body: "チェックアウトは何時ですか", question_id: 29, is_correct: false)
Answer.create!(body: "タクシーを呼んでもらえますか", question_id: 29, is_correct: false)
Answer.create!(body: "予約した〇〇です", question_id: 29, is_correct: false)
Answer.create!(body: "チェックインの前に荷物を置いてもいいですか", question_id: 29, is_correct: true)
Question.create!(title: "請幫我叫一輛計程車", body: "正しい日本語訳を選びましょう", category_id: 5)
Answer.create!(body: "チェックアウトは何時ですか", question_id: 30, is_correct: false)
Answer.create!(body: "タクシーを呼んでもらえますか", question_id: 30, is_correct: true)
Answer.create!(body: "予約した〇〇です", question_id: 30, is_correct: false)
Answer.create!(body: "近くにおすすめの飲食店はありますか", question_id: 30, is_correct: false)
...
Answer.create!(body: "予約した〇〇です", question_id: 31, is_correct: false)
Answer.create!(body: "近くにおすすめの飲食店はありますか", question_id: 31, is_correct: true)
Category.create!(name: "その他の単語や表現", body: "その他の単語や表現も学びましょう")
Question.create!(title: "洗手間在哪裡", body: "正しい日本語訳を選びましょう", category_id: 6)
Answer.create!(body: "〇〇に行きたいです", question_id: 32, is_correct: false)
Answer.create!(body: "トイレはどこですか", question_id: 32, is_correct: true)
Answer.create!(body: "もう一度言ってくれますか", question_id: 32, is_correct: false)
Answer.create!(body: "写真を撮ってくれますか", question_id: 32, is_correct: false)
Question.create!(title: "我想去〇〇", body: "正しい日本語訳を選びましょう", category_id: 6)
Answer.create!(body: "〇〇に行きたいです", question_id: 33, is_correct: true)
Answer.create!(body: "トイレはどこですか", question_id: 33, is_correct: false)
Answer.create!(body: "もう一度言ってくれますか", question_id: 33, is_correct: false)
Answer.create!(body: "写真を撮ってくれますか", question_id: 33, is_correct: false)
Question.create!(title: "可以再說一次嗎", body: "正しい日本語訳を選びましょう", category_id: 6)
Answer.create!(body: "〇〇に行きたいです", question_id: 34, is_correct: false)
Answer.create!(body: "トイレはどこですか", question_id: 34, is_correct: false)
Answer.create!(body: "もう一度言ってくれますか", question_id: 34, is_correct: true)
Answer.create!(body: "写真を撮ってくれますか", question_id: 34, is_correct: false)
...
Answer.create!(body: "トイレはどこですか", question_id: 35, is_correct: false)
Answer.create!(body: "もう一度言ってくれますか", question_id: 35, is_correct: false)
Answer.create!(body: "写真を撮ってくれますか", question_id: 35, is_correct: true)
